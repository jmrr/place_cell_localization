paramsDataset = struct(...
    ...
    'kernelPath', '../kernels/%s/%s/C%d', ... %../kernels/%s/%s/C%d', ... % '/media/bg-angel/datasets/RSM/kernels/%s/%s/C%d', ...
    'metric', 'max', ...
    'groundTruthPath', '../ground_truth', ... % /media/PictureThis/VISUAL_PATHS/v6.0/ground_truth
